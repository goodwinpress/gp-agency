...
function objects_preload() {
    ?>
     <link rel="preload" as="font" type="font/woff2" href="<?php echo get_bloginfo('template_url'); ?>/files/font/raleway/raleway-v22-latin_cyrillic-500.woff2" crossorigin>
     <link rel="preload" as="font" type="font/woff2" href="<?php echo get_bloginfo('template_url'); ?>/files/font/raleway/raleway-v22-latin_cyrillic-800.woff2" crossorigin>
...
function gp_filter_comment_fields( $fields ) {
    ...
    $fields['cookies'] = '<p class="comment-form-cookies-consent"><input id="wp-comment-cookies-consent" name="wp-comment-cookies-consent" type="checkbox" value="yes"' . $consent . ' />' . '<label for="wp-comment-cookies-consent">'.__('Сохранить имя и e-mail в этом браузере для моих последующих комментариев', 'gp-agency').'</label></p>';
    return $fields;
}
